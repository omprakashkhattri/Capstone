...
<title>Forgot Password - Redspot Car Rental</title>
...
<div class="d-flex justify-content-center align-items-center vh-100">
    <div class="card p-5" style="width: 400px;">
        ...
        <form method="POST" action="{{ route('password.request.user.submit') }}">
            @csrf
            <div class="mb-4">
        ...
        <div class="text-center back-login">
            <p>Remember your password? <a href="{{ route('login.user') }}">Login Here</a></p>
        </div>
    </div>
</div>
